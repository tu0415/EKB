<template>
	<view class="shift">
		...
		<view class="cont flexAI flexdcolumn">
			...
			<!-- <image class="code" src="/static/footer/tab001.png" mode=""></image> -->
			<text class="f28 ellipsis site">{{address}}</text>
			<view class="btn-box">
				<view class="btn f36 c021E34 bg00FFBA flex br45 h90 mt60" @click="copy()">
					复制钱包地址
				</view>
			</view>
		</view>
